...
public class CatalogueMetierImpl implements ICatalogueMetier {
	...
	public void ajouterProduit(Produit produit) {
		...
		String query = "INSERT INTO produit(REF_PROD,DESIGNATION,PRIX,QUNTITE) VALUES(?,?,?,?)";
		try {
	...
	public List<Produit> listProduits() {
		...
		try {
			...
			while (resultSet.next()) {
				...
				int quantite = resultSet.getInt("QUNTITE");
	...
	public void updateProduit(Produit p) {
		// REF_PROD,DESIGNATION,PRIX,QUNTITE)
		Connection connection=SingletonConnection.getInstance();
		String query = "UPDATE produit SET DESIGNATION=?,PRIX=?,QUNTITE=? WHERE REF_PROD=?";
		try {
			PreparedStatement ps=(PreparedStatement) connection.prepareStatement(query);
